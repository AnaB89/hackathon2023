...
| [removeMenuItem](../../../../extensions/ui-components/navigation/removemenuitem/)         | menuItemId:String-Number                                                                                           | Boolean                                                                         | Remove the menu item and all it's subMenuItems from the tree.                                                |
