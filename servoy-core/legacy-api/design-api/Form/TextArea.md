...
| [Number](../../JSLib/Number.md) | [printSliding](TextArea.md#printSliding)                   | Enables an element to resize based on its content and/or move when printing..                                    |
| [Boolean](../../JSLib/Boolean.md) | [printable](TextArea.md#printable)                   | Flag that tells if the component should be printed or not when the form is printed..                                    |
...
| [Boolean](../../JSLib/Boolean.md) | [titleDisplaysTags](TextArea.md#titleDisplaysTags)                   | Flag for header text to field component that enables or disables merging of data inside components using tags (placeholders)..                                    |
...
| [Boolean](../../JSLib/Boolean.md) | [visible](TextArea.md#visible)                   | The visible property of the component, default true..                                    |
...
| [void](../../void.md) | [onRender()](TextArea.md#onrender)                   | The method that is executed when the component is rendered..                                    |
