...
| [Number](../../../JSLib/Number.md) | [getScrollX()](RuntimeChecks.md#getscrollx)                   | Returns the x scroll location of specified element - only for an element where height of element is less than the height of element content..                                    |
