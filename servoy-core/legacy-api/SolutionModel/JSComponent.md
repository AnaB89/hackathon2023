...
| [Number](../JSLib/Number.md) | [printSliding](JSComponent.md#printSliding)                   | Enables an element to resize based on its content and/or move when printing..                                    |
| [Boolean](../JSLib/Boolean.md) | [printable](JSComponent.md#printable)                   | Flag that tells if the component should be printed or not when the form is printed..                                    |
